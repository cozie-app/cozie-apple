...
class QuestionViewModel: ObservableObject {
    ...
    @Published var list: [QuestionType] = [QuestionType(id: 0, title: "Weather (short)", link:                             "https://raw.githubusercontent.com/mariofrei/cozie-test/main/watch_surveys/watch_survey_weather_short.txt"),
