...
final class LogsSystemInteractor {
    ...
    func logsData() -> Logs {
        ...
        let fields = Fields(wssGoal: Int(settings.wss_goal),
                             ...
                             siWatchosVersion: "",
                             siIphoneModel: UIDevice.current.model,
                             siWatchModel: "",
                             siIphoneDeviceID: UIDevice.current.identifierForVendor!.uuidString,
                             siWatchDeviceID: "",
                             ...
                             appBundleName:  Bundle.main.infoDictionary?["CFBundleIdentifier"] as? String ?? "",
